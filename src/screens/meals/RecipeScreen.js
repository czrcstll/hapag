      ...
      <ScrollView>
        ...
        <View style={{ padding: 25 }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <Text style={{ flex: 2, fontSize: 22, fontWeight: 'bold' }}>Hearty Dumpling</Text>
            <Text style={{ flex: 1, fontSize: 22, fontWeight: 'bold', textAlign: 'right', color: '#44AF69' }}>502 kcal</Text>
          </View>

          <View style={{ marginTop: 15 }}>
            <Text style={{ color: '#4A4A6A' }}>Savory dish made with a tender and chewy dumpling wrapper, filled with a flavorful mixture of banana blossoms, vegetables, and herbs. The filling is usually rich and hearty, with a blend of umami flavors that make it incredibly satisfying to eat.</Text>
          </View>
          ...
          <View style={{ marginTop: 15, alignItems: 'center' }}>
            <View style={{ flexDirection: 'row' }}>
              <Text style={{ color: '#4A4A6A', fontWeight: 'bold' }}>Yield: </Text>
              <Text style={{ color: '#4A4A6A', marginEnd: 15 }}>20 servings</Text>
              <Text style={{ color: '#4A4A6A', fontWeight: 'bold' }}>Serving Size: </Text>
              <Text style={{ color: '#4A4A6A' }}>4 pcs/serving</Text>
            </View>
          </View>
          ...
          <View style={[{ marginTop: 15, backgroundColor: 'white', borderRadius: 15 }, styles.shadow]}>
            ...
            <View style={{ paddingHorizontal: 30, paddingVertical: 15 }}>
              <Text style={{ color: '#4A4A6A', fontWeight: 'bold' }}>Dumplings</Text>
              <Text style={{ color: '#4A4A6A', marginTop: 10 }}>
              ...
              <Text style={{ color: '#4A4A6A', fontWeight: 'bold', marginTop: 15 }}>Vinegar Dip</Text>
              <Text style={{ color: '#4A4A6A', marginTop: 10 }}>
          ...
          <Text style={{ textAlign: 'center', color: '#8E8EA9', fontWeight: 'bold', fontSize: 18, marginTop: 30 }} onPress={goBack}>Back</Text>
